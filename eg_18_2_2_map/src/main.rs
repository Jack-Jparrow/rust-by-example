/**
 * @Author: 白银
 * @Date: 2022-09-01 15:20:10
 * @LastEditTime: 2022-09-01 15:49:02
 * @LastEditors: 白银
 * @Description: process() 轻松取代了前面的所有函数，且更加紧凑 https://rustwiki.org/zh-CN/rust-by-example/error/option_unwrap/map.html
 */
