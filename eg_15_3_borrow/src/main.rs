/**
 * @Author: 白银
 * @Date: 2022-08-29 20:45:35
 * @LastEditTime: 2022-08-29 20:53:12
 * @LastEditors: 白银
 * @Description: 编译器（通过借用检查）静态地保证了引用总是指向有效的对象 https://rustwiki.org/zh-CN/rust-by-example/scope/borrow.html
 */
