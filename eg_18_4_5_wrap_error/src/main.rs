...
/**
 * @Author: 白银
 * @Date: 2022-09-01 18:17:59
 * @LastEditTime: 2022-09-01 18:30:14
 * @LastEditors: 白银
 * @Description: 把错误装箱这种做法也可以改成把它包裹到你自己的错误类型中 https://rustwiki.org/zh-CN/rust-by-example/error/multiple_error_types/wrap_error.html
 */
